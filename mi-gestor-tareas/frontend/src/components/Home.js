      ...
      <div className="row justify-content-center">
        <div className="col-lg-10">
          ...
          <div className="text-center mt-5 pt-5">
            <div className="card bg-white bg-opacity-10 border-0 text-white shadow-lg">
              <div className="card-body p-5">
                <h3 className="fw-bold mb-3">¿Listo para ser más productivo?</h3>
                <p className="mb-4">
                  Únete a miles de usuarios que ya están organizando su vida con nuestra plataforma.
                </p>
                <Link to="/register" className="btn btn-warning btn-lg px-5 shadow">
